...
{
  new (message_memory) sp_msgs::msg::Float32Stamped(_init);
}

void Float32Stamped_fini_function(void * message_memory)
{
  auto typed_message = static_cast<sp_msgs::msg::Float32Stamped *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Float32Stamped_message_member_array[2] = {
  {
    ...
    offsetof(sp_msgs::msg::Float32Stamped, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sp_msgs::msg::Float32Stamped, data),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Float32Stamped_message_members = {
  ...
  2,  // number of fields
  sizeof(sp_msgs::msg::Float32Stamped),
...
get_message_type_support_handle<sp_msgs::msg::Float32Stamped>()
{
  return &::sp_msgs::msg::rosidl_typesupport_introspection_cpp::Float32Stamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sp_msgs, msg, Float32Stamped)() {
  return &::sp_msgs::msg::rosidl_typesupport_introspection_cpp::Float32Stamped_message_type_support_handle;
}
