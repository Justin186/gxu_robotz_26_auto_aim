...
sp_msgs__msg__RMUCRobotPosition__init(sp_msgs__msg__RMUCRobotPosition * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    sp_msgs__msg__RMUCRobotPosition__fini(msg);
    return false;
  }
  // pose_x
  // pose_y
...
sp_msgs__msg__RMUCRobotPosition__create()
{
  ...
  sp_msgs__msg__RMUCRobotPosition * msg = (sp_msgs__msg__RMUCRobotPosition *)allocator.allocate(sizeof(sp_msgs__msg__RMUCRobotPosition), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(sp_msgs__msg__RMUCRobotPosition));
  bool success = sp_msgs__msg__RMUCRobotPosition__init(msg);
  if (!success) {
...
sp_msgs__msg__RMUCRobotPosition__Sequence__init(sp_msgs__msg__RMUCRobotPosition__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sp_msgs__msg__RMUCRobotPosition * data = NULL;

  if (size) {
    data = (sp_msgs__msg__RMUCRobotPosition *)allocator.zero_allocate(size, sizeof(sp_msgs__msg__RMUCRobotPosition), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = sp_msgs__msg__RMUCRobotPosition__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        sp_msgs__msg__RMUCRobotPosition__fini(&data[i - 1]);
      }
...
sp_msgs__msg__RMUCRobotPosition__Sequence__fini(sp_msgs__msg__RMUCRobotPosition__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      sp_msgs__msg__RMUCRobotPosition__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sp_msgs__msg__RMUCRobotPosition__Sequence * array = (sp_msgs__msg__RMUCRobotPosition__Sequence *)allocator.allocate(sizeof(sp_msgs__msg__RMUCRobotPosition__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = sp_msgs__msg__RMUCRobotPosition__Sequence__init(array, size);
  if (!success) {
...
sp_msgs__msg__RMUCRobotPosition__Sequence__destroy(sp_msgs__msg__RMUCRobotPosition__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    sp_msgs__msg__RMUCRobotPosition__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
sp_msgs__msg__RMUCRobotPosition__Sequence__are_equal(const sp_msgs__msg__RMUCRobotPosition__Sequence * lhs, const sp_msgs__msg__RMUCRobotPosition__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!sp_msgs__msg__RMUCRobotPosition__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  sp_msgs__msg__RMUCRobotPosition__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(sp_msgs__msg__RMUCRobotPosition);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    sp_msgs__msg__RMUCRobotPosition * data =
      (sp_msgs__msg__RMUCRobotPosition *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!sp_msgs__msg__RMUCRobotPosition__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          sp_msgs__msg__RMUCRobotPosition__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!sp_msgs__msg__RMUCRobotPosition__copy(
