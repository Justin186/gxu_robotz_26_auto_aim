...
bool sp_msgs__msg__rmuc_game_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sp_msgs.msg._rmuc_game_status.RMUCGameStatus", full_classname_dest, 44) == 0);
  }
  sp_msgs__msg__RMUCGameStatus * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of RMUCGameStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sp_msgs.msg._rmuc_game_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RMUCGameStatus");
