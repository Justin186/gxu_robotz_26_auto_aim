...
bool sp_msgs__msg__rmuc_robot_position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sp_msgs.msg._rmuc_robot_position.RMUCRobotPosition", full_classname_dest, 50) == 0);
  }
  sp_msgs__msg__RMUCRobotPosition * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of RMUCRobotPosition */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sp_msgs.msg._rmuc_robot_position");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RMUCRobotPosition");
