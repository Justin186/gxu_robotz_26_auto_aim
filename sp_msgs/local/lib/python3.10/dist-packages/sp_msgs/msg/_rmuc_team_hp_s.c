...
bool sp_msgs__msg__rmuc_team_hp__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sp_msgs.msg._rmuc_team_hp.RMUCTeamHP", full_classname_dest, 36) == 0);
  }
  sp_msgs__msg__RMUCTeamHP * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of RMUCTeamHP */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sp_msgs.msg._rmuc_team_hp");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RMUCTeamHP");
